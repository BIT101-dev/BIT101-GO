 ...
 * @LastEditTime: 2023-03-15 18:14:35
 * @Description: 学校统一身份验证
 */
package webvpn
...
func InitLogin() (InitLoginReturn, error) {
	...
	if err != nil || res.Code != 200 {
		return InitLoginReturn{}, errors.New("webvpn init_login error")
	}
...
func NeedCaptcha(username string) (bool, error) {
	...
	if err != nil || res.Code != 200 {
		return false, errors.New("webvpn need_captcha error")
	}
	var data struct {
...
func CaptchaImage(cookie string) ([]byte, error) {
	...
	if err != nil || res.Code != 200 {
		return nil, errors.New("webvpn captcha_image error")
	}
